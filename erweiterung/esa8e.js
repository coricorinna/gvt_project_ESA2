    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            case ('I'):
                ...
                illumination.light[1].position[0] = 0 - Math.cos(deltaLight) * r;
                illumination.light[1].position[2] = 0 - Math.sin(deltaLight) * r;
                illumination.light[0].position[0] = 0 - Math.cos(Math.PI + deltaLight) * r;
                illumination.light[0].position[2] = 0 - Math.sin(Math.PI + deltaLight) * r;
                break;
            case ('L'):
                deltaLight += deltaRotate;
                illumination.light[0].position[0] = Math.cos(deltaLight) * r;
                illumination.light[0].position[2] = Math.sin(deltaLight) * r;
                illumination.light[1].position[0] = Math.cos(Math.PI + deltaLight) * r;
                illumination.light[1].position[2] = Math.sin(Math.PI + deltaLight) * r;
                break;
            }
