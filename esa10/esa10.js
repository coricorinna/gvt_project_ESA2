var app = (function () {
    ...
    function start() {
        ...
        var selection = new URL(window.location.href).searchParams.get("ea10");
        if (["Run1", "Run2"].includes(selection)) {
            var readfile = "data/seeds/data_epsilon11_perplexity20_dim3_step155_" + selection + ".csv";
        } else {
            var readfile = "data/seeds/data_epsilon11_perplexity20_dim3_step155_Run1.csv";
        }

        Data.readFileFromServer(readfile);
    }
    ...
    function init_tSNE(data) {
        var opt = {};
        opt.epsilon = 11;       // epsilon is learning rate (10 = default)
