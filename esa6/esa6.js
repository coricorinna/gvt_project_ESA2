var app = (function () {
    ...
    function initModels() {
        ...
        createModel("torus", fs, [2.5, 0, 0], [0, 0, 0], [1.5, 1.5, 1.5]);
        createModel("plane", "wireframe", [0, -1, 0], [0, 0, 0], [1, 1, 1]);
        createModel("sphere", fs, [-2.5, 0, 0], [0, 0, 0], [0.3, 0.3, 0.3]);
        createModel("sphere", fs, [0, 0, -2.5], [0, 0, 0], [0.3, 0.3, 0.3]);
        createModel("sphere", fs, [2.5, 0, 0], [0, 0, 0], [0.3, 0.3, 0.3]);
        createModel("sphere", fs, [0, 0, 2.5], [0, 0, 0], [0.3, 0.3, 0.3]);
