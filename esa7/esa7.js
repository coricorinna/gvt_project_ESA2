var app = (function () {
    ...
    function initModels() {
        ...
        createModel("cylinder", fs, [1, 1, 1, 1], [-Math.PI / 4, 0.25, -Math.PI / 4], [0, 0, 0], [0.5, 0.5, 0.25]);
        createModel("torus", fs, [1, 1, 1, 1], [-Math.PI / 4, 0.25, -Math.PI / 4], [0, 0, 0], [0.8, 0.8, 0.4]);
        createModel("torus", fs, [1, 1, 1, 1], [-Math.PI / 4, 0.25, Math.PI / 4], [0, 0, 0], [0.8, 0.8, 0.4]);

        createModel("cylinder", fs, [1, 1, 1, 1], [-Math.PI / 4, 0.25, 0], [0, Math.PI / 2, 0], [0.5, 0.5, 0.25]);
        createModel("pillow", fs, [1, 1, 1, 1], [0, Math.PI / 8, 0], [Math.PI / 2, 0, 0], [1.25, 0.5, 0.25]);

        createModel("cylinder", fs, [1, 1, 1, 1], [Math.PI / 4, 0.25, -Math.PI / 4], [0, 0, 0], [0.5, 0.5, 0.25]);
        createModel("torus", fs, [1, 1, 1, 1], [Math.PI / 4, 0.25, -Math.PI / 4], [0, 0, 0], [0.8, 0.8, 0.4]);
        createModel("torus", fs, [1, 1, 1, 1], [Math.PI / 4, 0.25, Math.PI / 4], [0, 0, 0], [0.8, 0.8, 0.4]);

        createModel("cylinder", fs, [1, 1, 1, 1], [0, Math.PI / 3, 0], [Math.PI / 2, 0, 0], [0.25, 0.25, 0.125]);
        createModel("cylinder", fs, [1, 1, 1, 1], [-Math.PI / 10, 1.25, 0], [Math.PI / 2, Math.PI / 3, 0], [0.25, 0.25, 0.125]);

        createModel("cylinder", fs, [1, 1, 1, 1], [-Math.PI / 10, 1.25, -Math.PI / 14], [0, 0, 0], [0.25, 0.25, 0.075]);
        createModel("torus", fs, [1, 1, 1, 1], [-Math.PI / 10, 1.25, -Math.PI / 14], [0, 0, 0], [0.1, 0.1, 0.1]);
        createModel("torus", fs, [1, 1, 1, 1], [-Math.PI / 10, 1.25, Math.PI / 14], [0, 0, 0], [0.1, 0.1, 0.1]);

        createModel("cylinder", fs, [1, 1, 1, 1], [2 * Math.PI / 17, 0.86, -Math.PI / 14], [0, 0, 0], [0.25, 0.25, 0.075]);
        createModel("torus", fs, [1, 1, 1, 1], [2 * Math.PI / 17, 0.86, -Math.PI / 14], [0, 0, 0], [0.1, 0.1, 0.1]);
        createModel("torus", fs, [1, 1, 1, 1], [2 * Math.PI / 17, 0.86, Math.PI / 14], [0, 0, 0], [0.1, 0.1, 0.1]);
